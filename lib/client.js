...
class Client extends ClientBase {
  request (opts, callback) {
    ...
    try {
      ...
      this[kEnqueue](new RequestRequest(opts, callback))
    } catch (err) {
  ...
  stream (opts, factory, callback) {
    ...
    try {
      ...
      this[kEnqueue](new StreamRequest(opts, factory, callback))
    } catch (err) {
      process.nextTick(callback, err, null)
    }
  }
...
class RequestRequest extends Request {
  ...
  onBody (chunk, offset, length) {
    if (this.finished || !this.res || util.isDestroyed(this.res)) {
      return null
    }
